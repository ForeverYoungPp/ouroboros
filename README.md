...
[![Version 6.114.45](https://img.shields.io/badge/version-6.114.45-green.svg)](VERSION)
...
[download-macos-arm64]: https://github.com/razzant/ouroboros/releases/download/v6.114.45/Ouroboros-6.114.45.dmg
[download-windows-x64]: https://github.com/razzant/ouroboros/releases/download/v6.114.45/Ouroboros-6.114.45-windows-x64.zip
[download-linux-deb-amd64]: https://github.com/razzant/ouroboros/releases/download/v6.114.45/ouroboros_6.114.45_amd64.deb
[download-linux-rpm-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.114.45/ouroboros-6.114.45-1.x86_64.rpm
[download-linux-rpm-red80-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.114.45/ouroboros-6.114.45-1.red80.x86_64.rpm
[download-linux-appimage-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.114.45/Ouroboros-6.114.45-linux-x86_64.AppImage
[download-linux-x86_64]: https://github.com/razzant/ouroboros/releases/download/v6.114.45/Ouroboros-6.114.45-linux-x86_64.tar.gz
...
| 6.114.41 | 2026-09-13 | **fix(consciousness): the degradation receipt records the measurement that CAUSED the trim.** The BG context-degradation branch re-measured the projection after `_degrade_context_for_size` and wrote that post-trim size into the durable `consciousness_context_degraded` receipt as `physical_bytes` — so the number that actually crossed `BG_CONTEXT_MAX_CHARS`, the one that made the cycle act, survived only in a WARNING log line and the receipt could not be read back to justify the action. The receipt now carries `physical_bytes_before` (captured at the ceiling check, before the degrade call) beside the post-trim `physical_bytes`, so the trim is auditable from the durable event alone. Same class as the v6.114.37 honesty fix: a durable record must state the measurement that caused the action, not only the one after it. |

Older releases are preserved in Git tags and GitHub releases. Older 6.x rows (including 6.114.38, 6.114.37, 6.114.29, 6.110.1, 6.108.1, 6.106.0, 6.101.1, 6.97.2, 6.105.0, 6.97.1, 6.97.0, 6.96.1, 6.96.0, 6.95.0, 6.94.0, 6.93.0, 6.92.1, 6.92.0, 6.91.1, 6.90.3, 6.91.0, 6.90.2, 6.90.0, 6.87.5, 6.87.4, 6.87.3, 6.87.2, 6.84.0, 6.87.1, 6.83.0, 6.86.1, 6.81.1, 6.76.0, 6.75.0, 6.74.5, 6.74.4, 6.74.1, 6.74.0, 6.73.2, 6.73.1, 6.73.0, 6.72.0, 6.71.2, 6.71.1, 6.71.0, 6.70.0, 6.69.0, 6.68.0, 6.67.0, 6.66.0, 6.65.4, 6.65.3, 6.65.2, 6.65.1, 6.65.0, 6.64.3, 6.64.2, 6.64.1, 6.64.0, 6.63.0, 6.62.0, 6.61.4, 6.61.3, 6.61.1, 6.61.0, 6.60.0, 6.59.0, 6.58.0, 6.57.0, 6.56.0, 6.55.0, 6.54.4, 6.54.2, 6.54.1, 6.54.0, 6.53.4, 6.53.0, 6.51.0), the 5.2.0 through 5.33.0-rc.6 rows, and former `4.0.0` rows are rolled off to respect the P9 changelog cap; their full bodies remain at their git tags.
